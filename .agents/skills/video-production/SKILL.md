...
Run `09_check_production.py` for plan/implement/scene/render preflight. New scaffold and generated npm exports require state. Raw CLI exports must not bypass pending review. Read the reference for snapshot-based approvals, explicit legacy compatibility, and engineering test exceptions.
