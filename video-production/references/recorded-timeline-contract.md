...
```bash
uv run --python WORKSPACE/.venv/bin/python python SKILL/scripts/12_ingest_recorded.py --project-dir PROJECT --intake PROJECT/source-intake.json
uv run --python WORKSPACE/.venv/bin/python python SKILL/scripts/09_check_production.py --project-dir PROJECT --snapshot source
uv run --python WORKSPACE/.venv/bin/python python SKILL/scripts/11_scaffold_recorded.py --project-dir PROJECT
```
