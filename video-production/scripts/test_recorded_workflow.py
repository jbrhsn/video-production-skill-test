...
class RecordedWorkflowTests(unittest.TestCase):
    def setUp(self):
        ...
        self.write("analysis/asset-library-review.json", {"schema": "video-production-asset-library-review", "version": 1,
            "route": "recorded-edit", "assetsDir": ".video_production_assets", "collections": ["images", "audio/sfx"],
            "queries": [{"beatId": "intro", "query": "recorded overlay", "candidates": []}],
            "dispositions": [{"beatId": "intro", "outcome": "no-fit", "reason": "Fixture validates source-first editing."}]})
