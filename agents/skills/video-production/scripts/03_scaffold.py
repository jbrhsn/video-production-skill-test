...
Usage:
    uv run --python WORKSPACE/.venv/bin/python python SKILL/scripts/03_scaffold.py \\
...
def main() -> None:
    ...
    from workflow_v2 import read, validate_asset_library_review, validate_asset_manifest, validate_design_system, validate_execution
    ...
    validate_asset_library_review(project_dir)
    ...
    for name in ("09_check_production.py", "production.py", "workflow_v2.py", "asset_library.py"):
